...
class Vote(commands.Cog):
    ...
    async def create_vote_slash(self, interaction: discord.Interaction, channel: discord.TextChannel, question: str, required_votes: int, max_votes: int) -> None:
    ...
    async def create_vote_text(self, ctx: commands.Context, channel: discord.TextChannel, question: str, required_votes: int, max_votes: int) -> None:
